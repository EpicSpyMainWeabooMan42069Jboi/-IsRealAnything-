...
/**
 * Renderer 1: FaceOverlay - MYBEAUTIFULFACE.png overlay
 * Displays face PNG in sky that gets closer when player looks up
...
public class FaceOverlayRenderer {
    ...
    /**
     * Load or get cached face texture
     */
    private static Identifier getOrLoadTexture() {
        Identifier id = new Identifier("isrealanything", "textures/overlay/mybeautifulface.png");
        
        try {
            InputStream stream = FaceOverlayRenderer.class.getResourceAsStream(
                "/assets/isrealanything/textures/overlay/mybeautifulface.png"
            );
