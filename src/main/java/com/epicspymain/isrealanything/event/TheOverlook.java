...
public class TheOverlook {
     ...
     */
    private static final BlockPos MELTDOWN_LOCATION = new BlockPos(666, 84, -269);
    ...
    private static void beginMeltdown(ServerPlayerEntity player, MinecraftServer server) {
        ...
        // Force all remaining events except Event 41
    ...
    private static void crash(ServerPlayerEntity player) {
        ...
        // Actually kick the player with crash message
        player.networkHandler.disconnect(
            Text.literal("TheOverlook.ForbiddenAction\n\nDon't Say I Didn't Warn You")
        );
    }
